        ...
        <div class="w-full max-w-lg">
          <div class="w-full space-y-4">
            <div class="space-y-1.5 text-start">
              ...
              <p class="text-sm font-medium text-secondary-dark/90">Mulai perjalanan finansialmu. Daftar dan kelola keuangan lebih mudah.</p>
            </div>
            ...
            <form onsubmit={handleRegister}>
              <div class="space-y-4">
                ...
                <div class="space-y-1.5">
                  <label for="name" class="block text-sm font-medium text-secondary-dark">
                    Nama Lengkap
                  </label>
                  <Input
                    id="name"
